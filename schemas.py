"""Pydantic schemas for Jobber Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Jobber.")
    api_token: str = Field(description="Platform Access Token / API Key")
    base_url: str = Field(default="https://api.getjobber.com/api/graphql", description="Jobber API base URL.")
...
class GetProjectRecordParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    projectrecord_id: str = Field(description="Jobber ProjectRecord ID.")
